...
public class FirstSubTradeTest {

	private static Logger log = Logger.getLogger(FirstSubTradeTest.class);
	 ...
	 * @param btnClas
	 */
	@Test(description="进入子类型中第一个交易页面",dependsOnMethods={"getCro"},dataProvider = "getFirstSubTrade",dataProviderClass=PageParameters.class)
	public void getFirstSubTrade(Integer n, String elementClass,String baseClass,String quoteClass,
